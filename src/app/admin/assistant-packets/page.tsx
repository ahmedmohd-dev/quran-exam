...
export default function AssistantPacketsPage() {
  ...
  function packetHtml(packet: Packet) {
    ...
    const packetStyle = `style="--score-row-height:${compactPacket ? "5.5mm" : "8mm"};--homework-row-height:${compactPacket ? "6mm" : "8mm"};--questions-padding:${compactPacket ? "4mm" : "5mm"}"`;
